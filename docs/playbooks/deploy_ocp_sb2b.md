...
| Sterling B2Bi             | OpenShift           | Kubernetes          | helm-chart | Helm      |
|---------------------------|---------------------|---------------------|------------|-----------|
| 6.2.0.4                   | >= 4.14             | >= 1.27             | 3.0.6      | >= 3.15.x |
| 6.2.0.3                   | >= 4.14             | >= 1.27             | 3.0.5      | >= 3.15.x |
| 6.2.0.2                   | >= 4.14 and <= 4.15 | >= 1.27 and <= 1.29 | 3.0.4      | >= 3.14.x |
